...
public class ClanBankListener {
    ...
    public void onDeposit(BankPreTransactionEvent event) {
        ...
        if (entity instanceof PlayerAssociate) {
            final OfflinePlayer player = ((Clan.Associate) entity).getAsOfflinePlayer();
            final BigDecimal amount = event.getAmount();
            final boolean success;

            //noinspection DataFlowIssue
            Optional<Boolean> opt = EconomyProvision.getInstance().withdraw(amount, player);
